...
/**
 * Provides a form for reverting a GP revision for a single translation.
 *
 * @ingroup nidirect_gp
 */
class GpRevisionRevertTranslationForm extends GpRevisionRevertForm {
  ...
  public function getFormId() {
    return 'gp_revision_revert_translation_confirm';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $gp_revision = NULL, $langcode = NULL) {
    $this->langcode = $langcode;
    $form = parent::buildForm($form, $form_state, $gp_revision);
